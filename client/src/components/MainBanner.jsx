...
const MainBanner = () => {
  return (
    <div className='relative'>
        ...
        <div className='flex items-centre mt-6 front-medium'>
            ...
            Explore Deals
            <img className='transiton group-hover:translate-x-1' src={assets.black_arrow_icon} alt="arrow" />
            </Link>
            </div>
        </div>
    </div>
...
{console.log(assets.main_banner_bg)}
